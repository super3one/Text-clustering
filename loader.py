...
class TextProcessor(object):
    ...
    """set labels"""
    def get_labels(self):
        # label = [2900, 3017, 3201, 3234, 3259]
        # label = [2900, 3017, 3201, 3234, 3259, 1046, 1053, 1041, 3203, 3245]
       #  label = [3017, 2900, 3201, 3234, 3259, 3264,    4, 1046, 1053, 1041, 3203,
       # 3245, 3260,    5, 3033, 1014,   36, 1005, 1054,  466, 1008, 1038,
       # 3079, 3019, 3077, 3270, 3276, 3048,  438, 2918, 1010, 3305, 1052,
       # 3206, 1037, 3069]
       #  label = [2002, 1040,    3, 1019, 3044, 2019, 3275, 3073, 1039, 3045, 3256,
       # 2904, 3122, 1009, 3132,  499,  740, 3038, 3009, 3020, 3284, 3239]
        label = [9999, 3033, 3017, 3077, 5555, 3048, 3079, 3019, 3069, 1046, 1054,
       1041, 1053, 1037,    4, 1008,  466, 1014, 1052,    5, 1010,  438,
       1005, 1038, 3264, 3305, 3203, 3259, 3234, 3270, 3245, 3201, 3260,
       3206, 3276, 2900,   36, 2918]
        return [str(la) for la in label]
        # return ['体育', '财经', '房产', '家居', '教育', '科技', '时尚', '时政', '游戏', '娱乐']

    """read file"""
    def _read_file(self, input_file):
        with codecs.open(input_file, "r",encoding='gb18030') as f:
            lines = []

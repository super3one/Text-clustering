...
class TextConfig():
    ...
    batch_size = 10
    print_per_batch = 20   #print result
    require_improvement=200   #stop training if no inporement over 10 global_step

    output_dir='./result'
    data_dir='./data_dir'  #the path of input_data file
    vocab_file = './vocab_file/vocab.txt'  #the path of vocab file
    bert_config_file='./vocab_file/bert_config.json'  #the path of bert_cofig file
    init_checkpoint ='./vocab_file/bert_model.ckpt'   #the path of bert model
